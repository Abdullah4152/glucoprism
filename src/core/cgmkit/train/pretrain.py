...
# Baseline architectures live under baselines/common/models/ so that
# core holds only this paper's model and the backbone it builds on.
import os as _os, sys as _sys
from pathlib import Path as _P
_b = _P(_os.environ.get('GLUCOPRISM_ROOT',
        _P(__file__).resolve().parents[4])) / 'baselines'
...
from common.models.cgm_jepa import build_cgm_jepa, build_x_cgm_jepa, jepa_l1_loss
from ..models.blocks import apply_mask, init_weights
from ..models.glucofm import GlucoFM, GlucoFMConfig, sample_patch_mask
from common.models.gluformer import GluFormer, GluFormerConfig
