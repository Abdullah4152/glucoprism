...
from glucoprism.data.views import real_pair_index              # noqa: E402
from glucoprism.eval.probe import _metrics, _align_proba       # noqa: E402
...
def load_emb(name):
    ...
    if name == "GlucoFM":
        out = []
        for r in FM_RUNS:
            ck = ROOT / "experiments" / "kaggle_out" / r / "checkpoints" / "glucofm.pt"
            if ck.exists():
