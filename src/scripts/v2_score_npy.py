...
from glucoprism.eval.aggregate import agg_rich, _group_slices  # noqa: E402
from glucoprism.eval.probe import glucofm_probe, _metrics, _align_proba  # noqa: E402
...
ap.add_argument("--out", default=str(ROOT / "experiments" / "artifacts" / "v2_final_scores.csv"))
a = ap.parse_args()
