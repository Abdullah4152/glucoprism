...
from glucoprism.data.datasets import (CGMJEPADataset, GlucoFMDataset,  # noqa: E402
                                      GluFormerDataset, WindowShard,
                                      make_gluco_cache_keys)
from glucoprism.data.windows import densify  # noqa: E402
from glucoprism.train.pretrain import (pretrain_cgm_jepa, pretrain_glucofm,  # noqa: E402
                                       pretrain_gluformer)
from glucoprism.train.pretrain import pretrain_cqp  # noqa: E402
...
def main() -> int:
    ...
    if a.model == "cqp":
        from glucoprism.models.cqp import CQPConfig, cqp_param_report
        from glucoprism.models.glucofm import GlucoFMConfig
        ...
        from glucoprism.models.glucofm import glucofm_param_report
        ...
        if cross:
            ...
            if a.build_gluco_cache or not cache.exists():
                from glucoprism.data.glucodensity import precompute
