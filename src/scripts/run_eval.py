...
from glucoprism.data.gluformer_tokens import to_tokens  # noqa: E402
from glucoprism.data.windows import densify  # noqa: E402
from glucoprism.data.labels import TASK_MATRIX  # noqa: E402
from glucoprism.eval.probe import glucofm_probe, holm_bonferroni, paired_wilcoxon  # noqa: E402
from glucoprism.models.cgm_jepa import Encoder  # noqa: E402
from glucoprism.models.glucofm import GlucoFM, GlucoFMConfig  # noqa: E402
from glucoprism.models.gluformer import GluFormer, GluFormerConfig  # noqa: E402

from glucoprism.train.pretrain import get_device  # noqa: E402
...
def _make_prism_embedder(block: str):
    ...
    def _embed(ckpt: Path, shard: WindowShard, batch: int = 256) -> np.ndarray:
        from glucoprism.models.prism import GlucoPRISM, PrismConfig
        blob = torch.load(ckpt, map_location="cpu", weights_only=False)
        cfg_d = dict(blob["cfg"])
...
def embed_cqp(ckpt: Path, shard: WindowShard, batch: int = 256) -> np.ndarray:
    ...
    from glucoprism.models.cqp import CQPConfig, GlucoCQP
    blob = torch.load(ckpt, map_location="cpu", weights_only=False)
